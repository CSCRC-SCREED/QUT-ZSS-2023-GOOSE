...
911)
#Running malicious scenarios 911 -- inject mal_SV1_PUB (25ms HB) to fake normal situation only when a fault occurs
gnome-terminal --hide-menubar -t SV1_PUB --geometry=23x4+1700+190 -- ./snr/sv1_publisher
gnome-terminal --hide-menubar -t SV2_PUB --geometry=23x4+1700+300 -- ./snr/sv2_publisher 
gnome-terminal --hide-menubar -t SV1_PUB --geometry=23x4+1700+190 -- ./snr/sv1_publisher_911 ;;

912)
#Running malicious scenarios 912 -- inject mal_SV2_PUB (25ms HB) to fake normal situation only when a fault occurs
gnome-terminal --hide-menubar -t SV1_PUB --geometry=23x4+1700+190 -- ./snr/sv1_publisher
gnome-terminal --hide-menubar -t SV2_PUB --geometry=23x4+1700+300 -- ./snr/sv2_publisher 
gnome-terminal --hide-menubar -t SV2_PUB --geometry=23x4+1700+300 -- ./snr/sv2_publisher_912 ;;

913)
#Running malicious scenarios 913 -- alter SV1_PUB to fake normal situation even when a fault occurs
gnome-terminal --hide-menubar -t SV1_PUB --geometry=23x4+1700+190 -- ./snr/sv1_publisher_913
gnome-terminal --hide-menubar -t SV2_PUB --geometry=23x4+1700+300 -- ./snr/sv2_publisher ;;

914)
#Running malicious scenarios 914 -- alter SV2_PUB to fake normal situation even when a fault occurs
gnome-terminal --hide-menubar -t SV1_PUB --geometry=23x4+1700+190 -- ./snr/sv1_publisher
gnome-terminal --hide-menubar -t SV2_PUB --geometry=23x4+1700+300 -- ./snr/sv2_publisher_914 ;;
